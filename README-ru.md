...
**Corefetch** это neofetch-подобная утилита для красивого вывода информации о вашей системе с гибкой кастомизацией, написанная полностью на Rust с атрибутом `#![no_std]` и без зависимостей, кроме стандартного `alloc`. Полностью совместимая с [fastfetch](https://github.com/fastfetch-cli/fastfetch)
